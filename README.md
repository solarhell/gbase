[![GoDoc](https://pkg.go.dev/badge/github.com/solarhell/gbase)](https://pkg.go.dev/github.com/solarhell/gbase)
...
```go
import "github.com/solarhell/gbase"
```
...
```bash
# 主包
go doc -all github.com/solarhell/gbase

# Context
go doc -all github.com/solarhell/gbase/context
```
